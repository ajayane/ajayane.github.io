...
const qualificationContentEducation = document.getElementById("education"),
  ...
  combinedContentWork = document.getElementById("combined"),
  educationButton = document.getElementById("button-education"),
  combinedButton = document.getElementById("button-combined"),
...
if (combinedButton) {
  combinedButton.addEventListener("click", () => {
    combinedContentWork.className = "qualification__content";
    combinedContentWork.className =
      "qualification__content qualification__active";
    if (educationButton.classList.contains("qualification__active")) {
      educationButton.classList.remove("qualification__active");
    }
    ...
    if (!combinedButton.classList.contains("qualification__active")) {
      combinedButton.classList.add("qualification__active");
    }
  });
}
